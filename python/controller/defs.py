...
# Template WSPR.png
ANTENNA_TO_SS_ROUTE_WSPR_TMPLT = {
    ...
    '%s:%s' % (A_EFD_80_10, SS_IC7100):         {1: RELAY_NA, 2:RELAY_ON, 3:RELAY_OFF, 4:RELAY_ON, 5:RELAY_ON, 6:RELAY_NA},
...
# Template WSPR-1.png
ANTENNA_TO_SS_ROUTE_WSPR_1_TMPLT = {
    '%s:%s' % (A_EFD_80_10, SS_FCD_PRO_PLUS):   {1: RELAY_OFF, 2:RELAY_OFF, 3:RELAY_OFF, 4:RELAY_OFF, 5:RELAY_NA, 6:RELAY_NA},
    '%s:%s' % (A_DIPOLE_6_4_2, SS_FCD_PRO_PLUS):{1: RELAY_OFF, 2:RELAY_OFF, 3:RELAY_OFF, 4:RELAY_ON, 5:RELAY_NA, 6:RELAY_NA},
    '%s:%s' % (A_LOOP, SS_FCD_PRO_PLUS):        {1: RELAY_OFF, 2:RELAY_ON, 3:RELAY_NA, 4:RELAY_NA, 5:RELAY_ON, 6:RELAY_NA},
        
    '%s:%s' % (A_EFD_80_10, SS_WSPRRYPI):       {1: RELAY_ON, 2:RELAY_OFF, 3:RELAY_OFF, 4:RELAY_OFF, 5:RELAY_NA, 6:RELAY_NA},    
    '%s:%s' % (A_DIPOLE_6_4_2, SS_WSPRRYPI):    {1: RELAY_ON, 2:RELAY_OFF, 3:RELAY_OFF, 4:RELAY_ON, 5:RELAY_NA, 6:RELAY_NA},
    '%s:%s' % (A_LOOP, SS_WSPRRYPI):            {1: RELAY_ON, 2:RELAY_ON, 3:RELAY_NA, 4:RELAY_NA, 5:RELAY_ON, 6:RELAY_NA},    
    
    '%s:%s' % (A_EFD_80_10, SS_IC7100):         {1: RELAY_NA, 2:RELAY_NA, 3:RELAY_ON, 4:RELAY_OFF, 5:RELAY_NA, 6:RELAY_NA},    
    '%s:%s' % (A_DIPOLE_6_4_2, SS_IC7100):      {1: RELAY_NA, 2:RELAY_NA, 3:RELAY_ON, 4:RELAY_ON, 5:RELAY_NA, 6:RELAY_NA},
    
    # Tuning aid
    '%s:%s' % (A_LOOP, SS_VNA):                 {1: RELAY_NA, 2:RELAY_NA, 3:RELAY_NA, 4:RELAY_NA, 5:RELAY_OFF, 6:RELAY_NA},
}
# Set for the template here
ANTENNA_TO_SS_ROUTE = ANTENNA_TO_SS_ROUTE_WSPR_TMPLT
...
WSPR_BAND_TO_FREQ = {
    '160m':   (1836600, 1838100),
    '80m':    (3592600, 3594100),
    '60m':    (5287200, 5288700),
    '40m':    (7038600, 7040100),
    '30m':    (10138700, 10140200),
    '20m':    (14095600, 14097100),
    '17m':    (18104600, 18106100),
    '15m':    (21094600, 21096100),
    '12m':    (24924600, 24926100),
    '10m':    (28124600, 28126100),
    '6m':     (50293000, 50294500),
    '4m':     (70028600, 70029100),
    '2m':     (144488500, 144490000),         
}